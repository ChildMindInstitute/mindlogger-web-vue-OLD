...
export default {
  ...
  computed: {
    ...
    ui() {
      /* eslint-disable */
        if (this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/inputType']) {
          return this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/inputType'][0]['@value'];
        }
        return 'N/A';
        /* eslint-enable */
    },
    widgetType() {
      if (this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/readOnly']) {
        return this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/readOnly'][0]['@value'];
      }
      return false;
    },
    title() {
    ...
    valueConstraints() {
      if (this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/valueconstraints']) {
    ...
    findPassOptions() {
      if (this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/valueconstraints']) {
        ...
        if (Object.keys(this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/valueconstraints'][0]).indexOf('@id') > -1) {
          this.getRequiredVal();
          return this.requireVal;
        }
        // when valueConstraints in embedded in item object itself
        if (this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/valueconstraints'][0]) {
          // make sure the requiredValue key is defined
          if (this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/valueconstraints'][0]['http://schema.repronim.org/requiredValue']) {
            return this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/valueconstraints'][0]['http://schema.repronim.org/requiredValue'][0]['@value'];
          }
        }
      }
      return false;
  ...
  methods: {
    getRequiredVal() {
      jsonld.expand(this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/valueconstraints'][0]['@id'])
        .then((rsp) => {
    ...
    getData() {
      jsonld.expand(this.item['@id'], {
        ...
        if (resp.length) {
          ...
          if (this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/valueconstraints']) {
            if (Object.keys(this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/valueconstraints'][0]).indexOf('@id') > -1) {
              jsonld.expand(this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/valueconstraints'][0]['@id']).then((rsp) => {
                this.valueC = rsp[0];
              });
            } else {
              this.valueC = this.data['https://raw.githubusercontent.com/ReproNim/schema-standardization/master/terms/valueconstraints'][0];
            }
          } else {
